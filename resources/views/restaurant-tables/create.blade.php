                ...
                <div class="col-md-6 offset-md-3">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Create Restaurant Table</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('restaurant-tables.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('reservation_fee') is-invalid @enderror"
                                        id="reservation_fee" placeholder="Enter Reservation Fee" value="{{ old('reservation_fee') }}"
